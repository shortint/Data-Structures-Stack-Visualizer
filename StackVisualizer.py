...
class StackVisualizer:
      ...
      def heading_and_sub_heading(self): #Main heading, sub heading and indicator label set
          ...
          self.sub_heading = Label(self.stack_canvas, text="INDEX NUMBER", bg="DodgerBlue2", fg="white",  font=("Helvetica",19,"bold","italic"))
          self.sub_heading.place(x=9,y=300)
      ...
      def make_buttons(self): #Make Buttons to access and make top with arrow
          ...
          self.pop_btn = Button(self.window, text="POP", fg="Black", bg="white", font=("Arial", 15, "bold"),
      ...
      def set_index(self): #Index of the stack set
          ...
          self.index_0 = Label(self.stack_canvas, text="0", fg="white", bg="DodgerBlue2", font=("Arial", 15, "bold"))
          self.index_0.place(x=222, y=365)

          self.index_1 = Label(self.stack_canvas, text="1", fg="white", bg="DodgerBlue2", font=("Arial", 15, "bold"))
          self.index_1.place(x=222, y=332)

          self.index_2 = Label(self.stack_canvas, text="2", fg="white", bg="DodgerBlue2", font=("Arial", 15, "bold"))
          self.index_2.place(x=222, y=299)

          self.index_3 = Label(self.stack_canvas, text="3", fg="white", bg="DodgerBlue2", font=("Arial", 15, "bold"))
          self.index_3.place(x=222, y=266)

          self.index_4 = Label(self.stack_canvas, text="4", fg="white", bg="DodgerBlue2", font=("Arial", 15, "bold"))
          self.index_4.place(x=222, y=232)
      ...
      def push_element(self): #Push button action
          if len(self.last_label_value_keep) == 6:
             messagebox.showerror("OVERFLOW","Seems like stack is full. You can use POP to remove an element")
              ...
              self.add_btn = Button(self.window, text="ADD", font=("Arial", 10, "bold"), bg="white", fg="Black", relief=RAISED, bd=3, padx=3, pady=3, command=lambda: self.make_block('<Return>'))
      ...
      def make_block(self,e):#Element containing block making
          try:
              ...
              self.value_entry.set(" ")
              messagebox.showerror("ERROR", "Looks like you have entered some other datatype. Kindly, use integers")
